...
class CandidateControllerTest {
    ...
    @Test
    public void whenRequestCandidateModifyThenGetCandidatePage() {
        var id = 1;
        var candidateIdCaptor =  ArgumentCaptor.forClass(int.class);
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
        when(candidateService.findById(candidateIdCaptor.capture())).thenReturn(Optional.of(candidate));
        ...
        var actualId = candidateIdCaptor.getValue();
        var actualCities = model.getAttribute("cities");
    ...
    @Test
    public void whenRequestCandidateModifyThenGetErrorPageWithMessage() {
        when(candidateService.findById(any(int.class))).thenReturn(Optional.empty());
        var messageException = "Кандидат с указанным идентификатором не найден.";
    ...
    @Test
    public void whenPostUpdateCandidateWithFileThenRedirectToCandidatesPage() throws Exception {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var candidateArgumentCaptor = ArgumentCaptor.forClass(Candidate.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenPostUpdateCandidateAndSomeExceptionThrown() {
    ...
    @Test
    public void whenPostUpdateCandidateThenGetErrorPageWithMessage() {
        var expectedException = "Резюме с указанным идентификатором не найдено";
    ...
    public void whenDeleteCandidateThenRedirectToCandidatesPage() {
        var id = 1;
        var candidateIdCaptor = ArgumentCaptor.forClass(int.class);
        when(candidateService.deleteById(candidateIdCaptor.capture())).thenReturn(true);
    ...
    public void whenDeleteCandidateThenGetErrorPageWithMessage() {
        var expectedException = "Кандидат с указанным идентификатором не найден";
        when(candidateService.deleteById(any(int.class))).thenReturn(false);
