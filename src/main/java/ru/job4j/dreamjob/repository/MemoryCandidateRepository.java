...
public class MemoryCandidateRepository implements CandidateRepository {
    ...
    private MemoryCandidateRepository() {
        save(new Candidate(0, "Java Developer", "Java 17; Spring; PostgreSQL; HTML 5",
                LocalDateTime.of(2023, Month.OCTOBER, 1, 8, 30)));
        save(new Candidate(0, "Junior Java Developer", "Java 8; Spring MVC; Junit 5; CSS",
                LocalDateTime.of(2023, Month.OCTOBER, 4, 9, 30)));
        save(new Candidate(0, "Middle Java Developer", "Java 18; Spring Framework; Multithreading; J2E",
